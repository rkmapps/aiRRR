...
class CatalystNamespace {
    ...
    initialize(object, { type = 'auto', scope } = {}) {
        let appOptions = {};
        switch (type) {
            ...
            default:
                if (object && typeof object.headers === 'object') {
                    return this.initialize(object, { type: INIT_TYPE.advancedio, scope });
                }
                if (object && typeof object.catalystHeaders === 'object') {
                    return this.initialize(object, { type: INIT_TYPE.basicio, scope });
                }
